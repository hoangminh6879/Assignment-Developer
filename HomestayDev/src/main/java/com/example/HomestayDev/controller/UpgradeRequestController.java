...
public class UpgradeRequestController {
    ...
    public ResponseEntity<UpgradeRequestDto> approveRequest(@PathVariable UUID id, @RequestBody Map<String, String> body) {
    ...
    public ResponseEntity<UpgradeRequestDto> rejectRequest(@PathVariable UUID id, @RequestBody Map<String, String> body) {
        String adminNote = body.get("adminNote");
